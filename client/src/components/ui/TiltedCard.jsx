/**
 * Componente TiltedCard - Tarjeta con efecto 3D de inclinacion
 * @module components/ui/TiltedCard
 */
        ...
        >
            ...
            >
                <motion.img
                    ...
                    onError={(e) => {
                        e.target.src = `https://api.dicebear.com/7.x/shapes/svg?seed=${altText}`;
                    }}
                />
