...
const ServiceCard = ({ color, title, icon, subtitle, theme }) => (
    <div className={`flex flex-row justify-start items-center p-3 m-2 cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-xl ${
        theme === 'dark' 
            ? 'white-glassmorphism' 
        ...
        <div className="ml-5 flex flex-col flex-1">
            ...
            <p className={`mt-2 text-sm md:w-9/12 ${
...
const Services = () => {
    ...
    return(
        <div className="flex flex-col md:flex-row w-full justify-center items-center py-12">
            <div className="flex-1 flex flex-col justify-start items-start md:p-20 py-12 px-4">
                <h1 className={`text-3xl sm:text-5xl py-2 animate-fadeInLeft font-bold ${
                    theme === 'dark' ? 'text-white' : 'text-gray-900'
                }`}>
                    Services that we
                    <br />
                ...
                <p className={`mt-5 text-base animate-fadeInLeft delay-200 ${
                    theme === 'dark' ? 'text-white' : 'text-gray-800'
                }`}>
                    We are committed to providing the best crypto services in the industry.
                </p>
            </div>
            <div className="flex-1 flex flex-col justify-start items-center md:p-20 py-12 px-4 animate-fadeInRight">    
                <ServiceCard
                    color="bg-[#2952E3]"
